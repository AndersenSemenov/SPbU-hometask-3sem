...
namespace MatrixMultiply
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Measurements.PrintMeasurements((matrix1, matrix2) => matrix1.ParallelMultiply(matrix2));
            Measurements.PrintMeasurements((matrix1, matrix2) => matrix1.Multiply(matrix2));
